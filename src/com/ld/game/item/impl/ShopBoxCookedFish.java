...
public class ShopBoxCookedFish extends ShopBox {

	private Inventory playerInventory;
	
	public ShopBoxCookedFish(Map map, Inventory playerInventory, InventoryItem[] cost, Inventory inventory, InventoryItem returnItem) {
